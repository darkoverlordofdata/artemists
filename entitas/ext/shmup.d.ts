/**
 * Artemis-ECS definitions for shmup
 */
/**
 *
 *      ___       __            _   ______
...
declare module artemis {
    ...
    */
    class Entity {
        /** BEGIN: Entity Extensions for shmup */
        ...
        isParticle: boolean;
        setParticle(value: boolean);
        bounds: artemis.components.BoundsComponent;
        hasBounds: boolean;
        ...
        expires: artemis.components.ExpiresComponent;
        hasExpires: boolean;
        ...
        layer: artemis.components.LayerComponent;
        hasLayer: boolean;
        addLayer(ordinal:number);
        replaceLayer(ordinal:number);
        removeLayer();
        mouse: artemis.components.MouseComponent;
        hasMouse: boolean;
        ...
        move: artemis.components.MoveComponent;
        hasMove: boolean;
        addMove(speed:number, maxSpeed:number);
        replaceMove(speed:number, maxSpeed:number);
        removeMove();
        position: artemis.components.PositionComponent;
        hasPosition: boolean;
        addPosition(x:number, y:number);
        replacePosition(x:number, y:number);
        removePosition();
        resource: artemis.components.ResourceComponent;
        hasResource: boolean;
        addResource(name:string);
        replaceResource(name:string);
        removeResource();
        scale: artemis.components.ScaleComponent;
        hasScale: boolean;
        addScale(x:number, y:number);
        replaceScale(x:number, y:number);
        removeScale();
        scaleAnimation: artemis.components.ScaleAnimationComponent;
        ...
        score: artemis.components.ScoreComponent;
        hasScore: boolean;
        addScore(value:number);
        replaceScore(value:number);
        removeScore();
        soundEffect: artemis.components.SoundEffectComponent;
        hasSoundEffect: boolean;
        addSoundEffect(effect:number);
        replaceSoundEffect(effect:number);
        removeSoundEffect();
        tint: artemis.components.TintComponent;
        hasTint: boolean;
        addTint(rgb:number);
        replaceTint(rgb:number);
        removeTint();
        velocity: artemis.components.VelocityComponent;
        hasVelocity: boolean;
        addVelocity(x:number, y:number);
        replaceVelocity(x:number, y:number);
        removeVelocity();
        view: artemis.components.ViewComponent;
        hasView: boolean;
        addView(sprite:Object);
        replaceView(sprite:Object);
        removeView();
        isAddView: boolean;
        setAddView(value: boolean);
        /** END: Entity Extensions for shmup */
        uuid: string;
        private id_;
...
declare module artemis {
    ...
    */
    class World {
        /** BEGIN: World Extensions for shmup */
        initMappers(): void;
        scoreEntity: Entity;
        score: artemis.components.ScoreComponent;
        hasScore: boolean;
        ...
        firingEntity: Entity;
        isFiring: boolean;
        /** END: World Extensions for shmup */
        private em_;
        private cm_;
        delta: number;
        private added_;
