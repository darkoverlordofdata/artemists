module example.systems {
  ...
  export class EntitySpawningTimerSystem extends VoidEntitySystem {
    ...
    constructor(game:CCLayer) {
      ...
      this.timer1.execute = () => {
        this.world.createEntityFromTemplate('enemy', "enemy1", Layer.ACTORS_3, 10,
          MathUtils.nextInt(Constants.FRAME_WIDTH/2), Constants.FRAME_HEIGHT / 2 - 200, 0, -40, 20).addToWorld();
      ...
      this.timer2.execute = () => {
        this.world.createEntityFromTemplate('enemy', "enemy2", Layer.ACTORS_2, 20,
          MathUtils.nextInt(Constants.FRAME_WIDTH/2), Constants.FRAME_HEIGHT / 2 - 100, 0, -30, 40).addToWorld();
      ...
      this.timer3.execute = () => {
        this.world.createEntityFromTemplate('enemy', "enemy3", Layer.ACTORS_1, 60,
          MathUtils.nextInt(Constants.FRAME_WIDTH/2), Constants.FRAME_HEIGHT / 2 - 50, 0, -20, 70).addToWorld();
