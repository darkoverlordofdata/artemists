...
(function(artemis){var utils;(function(utils){var Bag=function(){function Bag(capacity){if(capacity===void 0)capacity=64;this.size_=0;this.data_=new Array(capacity)}Bag.prototype.removeAt=function(index){var data=this.data_;var e=data[index];data[index]=data[--this.size_];data[this.size_]=null;return e};Bag.prototype.remove=function(e){var i;var e2;var data=this.data_;var size=this.size_;for(i=0;i<size;i++){e2=data[i];if(e==e2){data[i]=data[--this.size_];data[this.size_]=null;return true}}return false};
Bag.prototype.removeLast=function(){if(this.size_>0){var data=this.data_;var e=data[--this.size_];data[this.size_]=null;return e}return null};Bag.prototype.contains=function(e){var i;var size;var data=this.data_;for(i=0,size=this.size_;size>i;i++)if(e===data[i])return true;return false};Bag.prototype.removeAll=function(bag){var modified=false;var i;var j;var l;var e1;var e2;var data=this.data_;for(i=0,l=bag.size();i<l;i++){e1=bag.get(i);for(j=0;j<this.size_;j++){e2=data[j];if(e1===e2){this.removeAt(j);
j--;modified=true;break}}}return modified};Bag.prototype.get=function(index){var data=this.data_;if(index>=data.length)throw new Error("ArrayIndexOutOfBoundsException");return data[index]};Bag.prototype.safeGet=function(index){var data=this.data_;if(index>=data.length)this.grow(index*7/4+1);return data[index]};Bag.prototype.size=function(){return this.size_};Bag.prototype.getCapacity=function(){return this.data_.length};Bag.prototype.isIndexWithinBounds=function(index){return index<this.getCapacity()};
Bag.prototype.isEmpty=function(){return this.size_==0};Bag.prototype.add=function(e){var data=this.data_;if(this.size_===data.length)this.grow();data[this.size_++]=e};Bag.prototype.set=function(index,e){var data=this.data_;if(index>=data.length)this.grow(index*2);this.size_=index+1;data[index]=e};Bag.prototype.grow=function(newCapacity){if(newCapacity===void 0)newCapacity=~~(this.data_.length*3/2)+1;this.data_.length=~~newCapacity};Bag.prototype.ensureCapacity=function(index){if(index>=this.data_.length)this.grow(index*
2)};Bag.prototype.clear=function(){var i;var size;var data=this.data_;for(i=0,size=this.size_;i<size;i++)data[i]=null;this.size_=0};Bag.prototype.addAll=function(items){var i;for(i=0;items.size()>i;i++)this.add(items.get(i))};return Bag}();utils.Bag=Bag})(utils=artemis.utils||(artemis.utils={}))})(artemis||(artemis={}));var artemis;
...
true};Signal.prototype.remove=function(listener){var listeners=this._listeners;listeners.remove(listener);this.active=listeners.size()>0};Signal.prototype.clear=function(){this._listeners.clear();this.active=false};return Signal}();utils.Signal=Signal})(utils=artemis.utils||(artemis.utils={}))})(artemis||(artemis={}));var artemis;
...
index);this.componentTypes_[artemis.getClassName(c)]=type;this.types.set(index,type)}return type};ComponentTypeFactory.prototype.getIndexFor=function(c){return this.getTypeFor(c).getIndex()};ComponentTypeFactory.prototype.getTaxonomy=function(index){return this.types.get(index).getTaxonomy()};return ComponentTypeFactory}();artemis.ComponentTypeFactory=ComponentTypeFactory})(artemis||(artemis={}));var artemis;
