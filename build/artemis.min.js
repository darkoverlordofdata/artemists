...
*/
var __extends=this&&this.__extends||function(d,b){for(var p in b)if(b.hasOwnProperty(p))d[p]=b[p];function __(){this.constructor=d}d.prototype=b===null?Object.create(b):(__.prototype=b.prototype,new __)};var artemis;(function(artemis){function getClassName(klass){return klass.className||klass.name}artemis.getClassName=getClassName})(artemis||(artemis={}));
(function(root,factory){if("function"===typeof define&&define.amd)define(factory);else if("object"===typeof exports)module.exports["artemis"]=factory();else root["artemis"]=factory()})(this,function(){return artemis});var artemis;
(function(artemis){var utils;(function(utils){var Bag=function(_super){__extends(Bag,_super);function Bag(capacity){if(capacity===void 0)capacity=64;_super.call(this);this.size_=0;this.length=capacity}Bag.prototype.removeAt=function(index){var e=this[index];this[index]=this[--this.size_];this[this.size_]=null;return e};Bag.prototype.remove=function(e){var i;var e2;var size=this.size_;for(i=0;i<size;i++){e2=this[i];if(e==e2){this[i]=this[--this.size_];this[this.size_]=null;return true}}return false};
Bag.prototype.removeLast=function(){if(this.size_>0){var e=this[--this.size_];this[this.size_]=null;return e}return null};Bag.prototype.contains=function(e){var i;var size;for(i=0,size=this.size_;size>i;i++)if(e===this[i])return true;return false};Bag.prototype.removeAll=function(bag){var modified=false;var i;var j;var l;var e1;var e2;for(i=0,l=bag.size();i<l;i++){e1=bag[i];for(j=0;j<this.size_;j++){e2=this[j];if(e1===e2){this.removeAt(j);j--;modified=true;break}}}return modified};Bag.prototype.get=
...
for(i=0;items.size()>i;i++)this.add(items.get(i))};return Bag}(Array);utils.Bag=Bag})(utils=artemis.utils||(artemis.utils={}))})(artemis||(artemis={}));var artemis;
...
MathUtils.nextDouble()*(end-start)};return MathUtils}();utils.MathUtils=MathUtils})(utils=artemis.utils||(artemis.utils={}))})(artemis||(artemis={}));var artemis;(function(artemis){var utils;(function(utils){})(utils=artemis.utils||(artemis.utils={}))})(artemis||(artemis={}));var artemis;
...
Trigger.prototype.calledOnFire=function(triggerStateType){};Trigger.prototype.checkConditionToFire=function(){return true};return Trigger}();blackboard.Trigger=Trigger})(blackboard=artemis.blackboard||(artemis.blackboard={}))})(artemis||(artemis={}));var artemis;
...
blackboard.SimpleTrigger=SimpleTrigger})(blackboard=artemis.blackboard||(artemis.blackboard={}))})(artemis||(artemis={}));var artemis;
...
(function(artemis){var Component=function(){function Component(){}Component.prototype.initialize=function(){var args=[];for(var _i=0;_i<arguments.length;_i++)args[_i-0]=arguments[_i]};return Component}();artemis.Component=Component})(artemis||(artemis={}));var artemis;
...
(function(artemis){var BitSet=artemis.utils.BitSet;var UUID=artemis.utils.UUID;var Entity=function(){function Entity(world,id,name){this.world_=world;this.id_=id;this.name=name;this.entityManager_=world.getEntityManager();this.componentManager_=world.getComponentManager();this.systemBits_=new BitSet;this.componentBits_=new BitSet;this.reset()}Entity.prototype.getId=function(){return this.id_};Entity.prototype.getComponentBits=function(){return this.componentBits_};Entity.prototype.getSystemBits=function(){return this.systemBits_};
...
(function(artemis){})(artemis||(artemis={}));var artemis;
...
(function(artemis){var Bag=artemis.utils.Bag;var ComponentType=artemis.ComponentType;var Aspect=artemis.Aspect;var ComponentTypeFactory=function(){function ComponentTypeFactory(){this.componentTypeCount_=0;this.componentTypes_={};this.types=new Bag;Aspect.typeFactory=this}ComponentTypeFactory.prototype.getTypeFor=function(c){if("number"===typeof c)return this.types[parseInt(c)];var type=this.componentTypes_[artemis.getClassName(c)];if(type==null){var index=this.componentTypeCount_++;type=new ComponentType(c,
index);this.componentTypes_[artemis.getClassName(c)]=type;this.types.set(index,type)}return type};ComponentTypeFactory.prototype.getIndexFor=function(c){return this.getTypeFor(c).getIndex()};ComponentTypeFactory.prototype.getTaxonomy=function(index){return this.types[index].getTaxonomy()};return ComponentTypeFactory}();artemis.ComponentTypeFactory=ComponentTypeFactory})(artemis||(artemis={}));var artemis;
...
function(e){var componentBits=e.getComponentBits();for(var i=componentBits.nextSetBit(0);i>=0;i=componentBits.nextSetBit(i+1))switch(this.typeFactory.getTaxonomy(i)){case Taxonomy.BASIC:this.componentsByType_[i].set(e.getId(),null);break;case Taxonomy.POOLED:var pooled=this.componentsByType_[i][e.getId()];this.pooledComponents_.freeByIndex(pooled,i);this.componentsByType_[i].set(e.getId(),null);break;default:throw new Error("InvalidComponentException"+" unknown component type: "+this.typeFactory.getTaxonomy(i));
}componentBits.clear()};ComponentManager.prototype.addComponent=function(e,type,component){this.componentsByType_.ensureCapacity(type.getIndex());var components=this.componentsByType_[type.getIndex()];if(components==null){components=new Bag;this.componentsByType_.set(type.getIndex(),components)}components.set(e.getId(),component);e.getComponentBits().set(type.getIndex())};ComponentManager.prototype.removeComponent=function(e,type){var index=type.getIndex();switch(type.getTaxonomy()){case Taxonomy.BASIC:this.componentsByType_[index].set(e.getId(),
null);e.getComponentBits().clear(type.getIndex());break;case Taxonomy.POOLED:var pooled=this.componentsByType_[index][e.getId()];e.getComponentBits().clear(type.getIndex());this.pooledComponents_.free(pooled,type);this.componentsByType_[index].set(e.getId(),null);break;default:throw new Error("InvalidComponentException"+type+" unknown component type: "+type.getTaxonomy());}};ComponentManager.prototype.getComponentsByType=function(type){var components=this.componentsByType_[type.getIndex()];if(components==
null){components=new Bag;this.componentsByType_.set(type.getIndex(),components)}return components};ComponentManager.prototype.getComponent=function(e,type){var components=this.componentsByType_[type.getIndex()];if(components!=null)return components[e.getId()];return null};ComponentManager.prototype.getComponentsFor=function(e,fillBag){var componentBits=e.getComponentBits();for(var i=componentBits.nextSetBit(0);i>=0;i=componentBits.nextSetBit(i+1))fillBag.add(this.componentsByType_[i][e.getId()]);
return fillBag};ComponentManager.prototype.deleted=function(e){this.deleted_.add(e)};ComponentManager.prototype.clean=function(){if(this.deleted_.size()>0){for(var i=0;this.deleted_.size()>i;i++)this.removeComponentsOfEntity(this.deleted_[i]);this.deleted_.clear()}};return ComponentManager}(Manager);artemis.ComponentManager=ComponentManager})(artemis||(artemis={}));var artemis;
(function(artemis){var ComponentMapper=function(){function ComponentMapper(type,world){this.type_=world.getComponentManager().typeFactory.getTypeFor(type);this.components_=world.getComponentManager().getComponentsByType(this.type_);this.classType_=type}ComponentMapper.prototype.get=function(e){return this.components_[e.getId()]};ComponentMapper.prototype.getSafe=function(e){if(this.components_.isIndexWithinBounds(e.getId()))return this.components_[e.getId()];return null};ComponentMapper.prototype.has=
function(e){return this.getSafe(e)!=null};ComponentMapper.getFor=function(type,world){return new ComponentMapper(type,world)};return ComponentMapper}();artemis.ComponentMapper=ComponentMapper})(artemis||(artemis={}));var artemis;
(function(artemis){var Bag=artemis.utils.Bag;var BitSet=artemis.utils.BitSet;var Manager=artemis.Manager;var EntityManager=function(_super){__extends(EntityManager,_super);function EntityManager(){_super.call(this);this.entities_=new Bag;this.disabled_=new BitSet;this.identifierPool_=new IdentifierPool;this.active_=0;this.added_=0;this.created_=0;this.deleted_=0}EntityManager.prototype.initialize=function(){};EntityManager.prototype.createEntityInstance=function(name){var e=new artemis.Entity(this.world_,
this.identifierPool_.checkOut(),name);this.created_++;return e};EntityManager.prototype.added=function(e){this.active_++;this.added_++;this.entities_.set(e.getId(),e)};EntityManager.prototype.enabled=function(e){this.disabled_.clear(e.getId())};EntityManager.prototype.disabled=function(e){this.disabled_.set(e.getId())};EntityManager.prototype.deleted=function(e){this.entities_.set(e.getId(),null);this.disabled_.clear(e.getId());this.identifierPool_.checkIn(e.getId());this.active_--;this.deleted_++};
EntityManager.prototype.isActive=function(entityId){return this.entities_[entityId]!=null};EntityManager.prototype.isEnabled=function(entityId){return!this.disabled_.get(entityId)};EntityManager.prototype.getEntity=function(entityId){return this.entities_[entityId]};EntityManager.prototype.getActiveEntityCount=function(){return this.active_};EntityManager.prototype.getTotalCreated=function(){return this.created_};EntityManager.prototype.getTotalAdded=function(){return this.added_};EntityManager.prototype.getTotalDeleted=
function(){return this.deleted_};return EntityManager}(Manager);artemis.EntityManager=EntityManager;var IdentifierPool=function(){function IdentifierPool(){this.nextAvailableId_=0;this.ids_=new Bag}IdentifierPool.prototype.checkOut=function(){if(this.ids_.size()>0)return this.ids_.removeLast();return this.nextAvailableId_++};IdentifierPool.prototype.checkIn=function(id){this.ids_.add(id)};return IdentifierPool}()})(artemis||(artemis={}));var artemis;(function(artemis){})(artemis||(artemis={}));var artemis;
...
function(es){var index=SystemIndexManager.indices.get(es);if(index===undefined){index=SystemIndexManager.INDEX++;SystemIndexManager.indices.put(es,index)}return index};SystemIndexManager.INDEX=0;SystemIndexManager.indices=new HashMap;return SystemIndexManager}()})(artemis||(artemis={}));var artemis;
...
function(){};PlayerManager.prototype.deleted=function(e){this.removeFromPlayer(e)};return PlayerManager}(Manager);managers.PlayerManager=PlayerManager})(managers=artemis.managers||(artemis.managers={}))})(artemis||(artemis={}));var artemis;
...
(artemis.managers={}))})(artemis||(artemis={}));var artemis;
...
TeamManager})(managers=artemis.managers||(artemis.managers={}))})(artemis||(artemis={}));var artemis;
(function(artemis){var systems;(function(systems){var EntitySystem=artemis.EntitySystem;var DelayedEntityProcessingSystem=function(_super){__extends(DelayedEntityProcessingSystem,_super);function DelayedEntityProcessingSystem(aspect){_super.call(this,aspect)}DelayedEntityProcessingSystem.prototype.processEntities=function(entities){for(var i=0,s=entities.size();s>i;i++){var entity=entities[i];this.processDelta(entity,this.acc_);var remaining=this.getRemainingDelay(entity);if(remaining<=0)this.processExpired(entity);
...
function(){if(this.running_)return this.delay_-this.acc_;return 0};DelayedEntityProcessingSystem.prototype.isRunning=function(){return this.running_};DelayedEntityProcessingSystem.prototype.stop=function(){this.running_=false;this.acc_=0};return DelayedEntityProcessingSystem}(EntitySystem);systems.DelayedEntityProcessingSystem=DelayedEntityProcessingSystem})(systems=artemis.systems||(artemis.systems={}))})(artemis||(artemis={}));var artemis;
(function(artemis){var systems;(function(systems){var EntitySystem=artemis.EntitySystem;var EntityProcessingSystem=function(_super){__extends(EntityProcessingSystem,_super);function EntityProcessingSystem(aspect){_super.call(this,aspect)}EntityProcessingSystem.prototype.processEach=function(e){};EntityProcessingSystem.prototype.processEntities=function(entities){for(var i=0,s=entities.size();s>i;i++)this.processEach(entities[i])};EntityProcessingSystem.prototype.checkProcessing=function(){return true};
return EntityProcessingSystem}(EntitySystem);systems.EntityProcessingSystem=EntityProcessingSystem})(systems=artemis.systems||(artemis.systems={}))})(artemis||(artemis={}));var artemis;
...
systems.IntervalEntitySystem=IntervalEntitySystem})(systems=artemis.systems||(artemis.systems={}))})(artemis||(artemis={}));var artemis;
