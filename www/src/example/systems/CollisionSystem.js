...
(function (brokenspork) {
    ...
    (function (systems) {
        ...
        var CollisionSystem = (function (_super) {
            ...
            CollisionSystem.prototype.initialize = function () {
                ...
                this.collisionPairs.add(new CollisionPair(this, Constants.Groups.PLAYER_BULLETS, Constants.Groups.ENEMY_SHIPS, {
                    handleCollision: function (bullet, ship) {
                        ...
                        for (var i = 0; 4 > i; i++)
                            EntityFactory.createParticle(self.world, bp.x, bp.y).addToWorld();
            ...
            __decorate([
                Mapper
            ], CollisionSystem.prototype, "Position");
            __decorate([
                Mapper
            ], CollisionSystem.prototype, "Bounds");
            __decorate([
                Mapper
            ], CollisionSystem.prototype, "Health");
            __decorate([
                Mapper
            ], CollisionSystem.prototype, "Expires");
