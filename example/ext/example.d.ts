/**
 * Artemis-ECS definitions for example
 */
/**
 *
 *      ___       __            _   ______
...
declare module artemis {
    ...
    */
    class Entity {
        /** BEGIN: Entity Extensions for example */
        start(name?:string): Entity;
        bounds: artemis.components.BoundsComponent;
        hasBounds: boolean;
        addBounds(radius:number);
        replaceBounds(radius:number);
        removeBounds();
        colorAnimation: artemis.components.ColorAnimationComponent;
        ...
        removeSoundEffect();
        sprite: artemis.components.SpriteComponent;
        hasSprite: boolean;
...
declare module artemis {
    ...
    */
    class World {
        /** BEGIN: World Extensions for example */
        loadExtensions(): void;
        scoreEntity: Entity;
        score: artemis.components.ScoreComponent;
        hasScore: boolean;
        ...
        removeScore(): void;
        /** END: World Extensions for example */
        private em_;
        private cm_;
        delta: number;
        private added_;
